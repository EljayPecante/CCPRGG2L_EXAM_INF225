public class Recursion {
    ...
    public static void main(String[] args) {
        ...
        // 1. If the last letter of your surname is a vowel, remove all vowel in
        // your full name.

        // 2. If the last letter of your surname is a vowel, remove all
        // vowels in your full name.
        ...
        String fullName = "eljay matthew pecante";
    ...
    private static String removeLetter(String fullName, int vowelCheck, String result, int index) {
        ...
        String vowel = "aeiou";
        int isVowel = vowel.indexOf(letter) >= 0 ? 0 : 1;
